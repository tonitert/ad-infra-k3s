...
You have access to a development kubernetes cluster. The kubeconfig is in k3s_kubeconfig.yaml. To get the cluster api reachable, you might need to connect to ctfnote.ad.tertsonen.xyz:6443 first. The cluster might time out sometimes, retry a couple of times when this happens.
